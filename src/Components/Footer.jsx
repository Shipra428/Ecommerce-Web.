                ...
                <div className="container py-5">
                    <div className="row g-5">
                        <div className="col-lg-4 col-md-6">
                            ...
                            <Link className="mb-2 text-light d-block" to="tel:+916306616775">
                                <i className="fa fa-phone me-3"></i>+91-6306616775
                            </Link>
                            <Link className="mb-2 text-light d-block" to="mailto:shahushipra@gmail.com">
                                <i className="fa fa-envelope me-3"></i>shahushipra@gmail.com
                            </Link>
